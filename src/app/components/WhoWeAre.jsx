      ...
      <div className="mx-auto max-w-7xl flex flex-col lg:flex-row justify-between w-full gap-[6.25rem] px-8 py-12 r">
        <div className="flex flex-col gap-8 w-full lg:w-1/2">
          ...
          <div className="flex flex-col gap-6">
            ...
            <button 
              className="bg-[#FFBF00] flex gap-4 items-center justify-center md:w-1/2 xl:w-1/3 whitespace-nowrap rounded-[1.25rem] text-black px-4 py-5 font-semibold mt-6 hover:bg-[#FFBF00] hover:text-white transition-colors"
              aria-label="Learn More about Purpose Drive Global"
              type="button">
              Learn More
              <Image
                src='/Vector.svg'
